...
|---|---|
| Idle | `(215,88) -> (246,119)` |
| Walk | `(289,88) -> (320,119)` ; `(322,88) -> (353,119)` |
| Jump | `(215,132) -> (246,163)` |
| Pipe | `(215,176) -> (246,207)` |
| Crouch | `(252,88) -> (283,119)` |
### Fireball (Loaded from player.png)

- **Control**: Shoot key (`KEY_J` by default, rebindable)
- **Animation**: `(152,183) -> (159,190)` ; `(162,183) -> (169,190)` (alternating between the two)
- Shoots out in the direction the player is facing, bounces off solid ground, and kills enemies on contact.
