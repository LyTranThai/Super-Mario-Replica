...
void GameEngine::init() {
    ...
    AssetManager::getInstance().loadTexture("mobs", "assets/textures/mobs.png");
    ...
    AssetManager::getInstance().loadTexture("nobackgroundcloud", "assets/textures/nobackgroundcloud.png");
